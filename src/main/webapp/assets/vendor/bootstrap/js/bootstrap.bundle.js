  ...
  */
  ...
  class Dropdown extends BaseComponent {
    ...
    _getConfig(config) {
      ...
      typeCheckConfig(NAME$8, config, this.varructor.DefaultType);
  ...
  class Tooltip extends BaseComponent {
    ...
    _initializeOnDelegatedTarget(event, context) {
      ...
      if (!context) {
        context = new this.varructor(event.delegateTarget, this._getDelegateConfig());
  ...
  class ScrollSpy extends BaseComponent {
    ...
    _activate(target) {
      ...
      var queries = this._selector.split(',').map(selector => `${selector}[data-bs-target="${target}"],${selector}[href="${target}"]`);
