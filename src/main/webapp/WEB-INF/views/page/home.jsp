		...
		<div class="carousel-inner">
			<div class="carousel-item active  ">
				<img class="d-block w-100 img-slider rounded"
					src="assets/img/slide-1.jpg" alt="First slide">

				<div class="carousel-caption d-none d-md-block ">
					<div class="badge bg-warning text-wrap sale">Open Sale
						Discount 50%</div>
					<h2 class="mt-5 fs-1 fw-bold text-dark ">
						Supermarket For <br> Fresh Gocery
					</h2>
					<p class="text-secondary">Introduce a new model for online
						grocery shopping and covient home delivery</p>
					<button type="button" class="btn btn-dark">
						Shop Now<i class="bi bi-arrow-right-short ms-2"></i>
					</button>
				</div>
			...
			<div class="carousel-item  text-left  ">
				<img class="d-block w-100 img-slider rounded"
					src="assets/img/slider-2.jpg" alt="Second slide">
				<div class="carousel-caption    d-none d-md-block">
					<div class="badge bg-warning text-wrap sale">Open Sale
						Discount 50%</div>
					<h2 class="mt-5 fs-1 fw-bold text-dark ">
	...
	<div class="container mb-5 catagory">
		<div class="row">
			<div class="col-12 mb-6">
				<h5 class="fw-bold mb-5 fs-3">Features Catagory</h5>
			</div>
		</div>
		<nav class="row gy-2">
				...
				<div class="row">
						...
						<a href="#" class="text-center">
							<div class="card justify-content-center align-items-center pt-3">
								<img class="card-img-top"
									src="assets/img/catagory/thanh-long.webp" alt="Card image cap">
								<div class="card-body">
					...
					<div class="col-3">
						<a href="#" class="text-center">
							<div class="card justify-content-center align-items-center pt-3">
								<img class="card-img-top"
									src="assets/img/catagory/thuc-pham-kho.webp"
									alt="Card image cap">
								<div class="card-body">
					...
					<div class="col-3">
						<a href="#" class="text-center">
							<div class="card justify-content-center align-items-center pt-3">
								<img class="card-img-top"
									src="assets/img/catagory/suon-heo.webp" alt="Card image cap">
								<div class="card-body">
			...
			<div class="col-lg-6 col-md-12">
				<div class="row">
					<div class="col-3">
						<a href="#" class="text-center ">
							<div class="card justify-content-center align-items-center pt-3">
								<img class="card-img-top" src="assets/img/catagory/banh.jpg"
									alt="Card image cap">
								<div class="card-body">
					...
					<div class="col-3">
						<a href="#" class="text-center">
							<div class="card justify-content-center align-items-center pt-3">
								<img class="card-img-top" src="assets/img/catagory/tea.jpg"
									alt="Card image cap">
								<div class="card-body">
					...
					<div class="col-3">
						<a href="#" class="text-center ">
							<div class="card justify-content-center align-items-center pt-3">
								<img class="card-img-top"
									src="assets/img/catagory/instant-food.jpg" alt="Card image cap">
								<div class="card-body">
					...
					<div class="col-3">
						<a href="#" class="text-center ">
							<div class="card justify-content-center align-items-center pt-3">
								<img class="card-img-top" src="assets/img/catagory/baby.jpg"
									alt="Card image cap">
								<div class="card-body">
...
<div class="container banner  py-5">
	<div class="row">
		<div class="col-12 col-md-6 mb-3 mb-lg-0">
			<div>
				<div class="rounded img"
					style="background: url(assets/img/banner1.png) no-repeat; background-size: cover; background-position: center;">
					<div>
		...
		<div class="col-12 col-md-6 ">
			...
			<div>
				<div class="rounded img"
					style="background: url(assets/img/banner2.jpg) no-repeat; background-size: cover; background-position: center;">
					<div>
...
<section class="my-lg-14 my-8 mb-5">
	<div class="container">
		<div class="row">
			<div class="col-12 mb-6">
				<h5 class="fw-bold mb-5 fs-3">Popular Product</h5>
			</div>
		</div>
				...
				<div class="card card-product">
					<div class="card-body">
						...
						<div class="text-warning">
							...
							<small> <i class="bi bi-star-fill"></i> <i
								class="bi bi-star-fill"></i> <i class="bi bi-star-fill"></i> <i
								class="bi bi-star-fill"></i> <i class="bi bi-star-fill"></i></small> <span
			...
			<div class="col">
				<div class="card card-product">
					<div class="card-body">
						<div class="text-center position-relative">
							<a href="./pages/shop-single.html"><img
								src="assets/img/products/product-img-4.jpg"
								alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>
							<div class="card-product-action">
								<a href="#!" class="btn-action" data-bs-toggle="modal"
									data-bs-target="#quickViewModal"><i class="bi bi-eye"
						...
						<div class="text-warning">
							...
							<small> <i class="bi bi-star-fill"></i> <i
								class="bi bi-star-fill"></i> <i class="bi bi-star-fill"></i> <i
								class="bi bi-star-half"></i> <i class="bi bi-star"></i></small> <span
				...
				<div class="col">
					<div class="card card-product">
						<div class="card-body">
							...
							<h2 class="fs-6">
								<a href="./pages/shop-single.html"
									class="text-inherit text-decoration-none">Roast Ground
									Coffee</a>
							</h2>
							...
							<div class="d-flex justify-content-start text-center mt-3">
								<div class="deals-countdown w-100"
									...
									<span class="countdown-section"><span
										class="countdown-amount hover-up">2017</span><span
										...
										class="countdown-section"><span
										class="countdown-amount hover-up">24</span><span
										class="countdown-period"> mins </span></span><span
										class="countdown-section"><span
										class="countdown-amount hover-up">46</span><span
				...
				<div class="col">
					<div class="card card-product">
						<div class="card-body">
							...
							<h2 class="fs-6">
								<a href="./pages/shop-single.html"
									class="text-inherit text-decoration-none">Crushed Tomatoes</a>
							</h2>
							<div
								class="d-flex justify-content-between align-items-center mt-3">
								<div>
							...
							<div class="d-flex justify-content-start text-center mt-3 w-100">
								<div class="deals-countdown w-100"
									...
									<span class="countdown-section"><span
										class="countdown-amount hover-up">2077</span><span
										class="countdown-period"> days </span></span><span
										class="countdown-section"><span
										class="countdown-amount hover-up">09</span><span
										class="countdown-period"> hours </span></span><span
				...
				<div class="col">
					<div class="card card-product">
						<div class="card-body">
							...
							<h2 class="fs-6">
								<a href="./pages/shop-single.html"
									class="text-inherit text-decoration-none">Golden Pineapple</a>
							</h2>
							<div
								class="d-flex justify-content-between align-items-center mt-3">
								<div>
							...
							<div class="d-flex justify-content-start text-center mt-3">
								<div class="deals-countdown w-100"
									...
									<span class="countdown-section"><span
										class="countdown-amount hover-up">2049</span><span
										class="countdown-period"> days </span></span><span
										class="countdown-section"><span
										class="countdown-amount hover-up">09</span><span
										class="countdown-period"> hours </span></span><span
			...
			<div class="col-md-6 col-lg-3">
				<div class="mb-8 mb-xl-0">
					...
					<p>
						...
						a refund within hours. No questions asked <a href="#!">policy</a>.
					</p>
				</div>
			</div>
		</div>
