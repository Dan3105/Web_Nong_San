...
<div class="d-flex flex-column flex-shrink-0 p-3 ">
	<div class="row px-4">
		<div class="col-3">
			<img src="<c:url value="/assets/img/account/${account.avatar} "/>" class="rounded-circle"
	...
	<ul class="nav nav-pills flex-column mb-auto">
		...
		<li class="nav-item"><a href="account/address.htm" class="nav-link"
			aria-current="page"> <i class="bi bi-geo-alt-fill"></i> Địa
				chỉ hiện tại
		</a></li>

		<li class="nav-item"><a href="account/changePassword.htm"
			class="nav-link" aria-current="page"> <i class="bi bi-key-fill"></i></i>
				Đổi mật khẩu
		</a></li>
